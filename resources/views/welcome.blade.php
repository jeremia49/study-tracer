...
<html lang="en" class="dark">
  ...
  <body class="bg-gray-50 dark:bg-gray-800">
    ...
    <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
            ...
            >
              <ul class="space-y-2">
                <li>
                  <a
                    href="#"
                    class="flex items-center bg-gray-100 p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 dark:bg-gray-300/50 dark:text-gray-200 dark:hover:bg-gray-700 group"
                  >
                    <svg
                      class="w-6 h-6 transition duration-75 text-emerald-500 group-hover:text-emerald-500 dark:text-emerald-400 dark:group-hover:text-white"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                      xmlns="http://www.w3.org/2000/svg"
                    >
      ...
      <div
        class="fixed inset-0 z-10 hidden lg:hidden bg-gray-900/50 dark:bg-gray-900/90"
        id="sidebarBackdrop"
      ></div>
      ...
      >
        ...
        <footer
          class="p-4 mt-6 bg-white md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800"
        >
