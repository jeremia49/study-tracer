          ...
          <div class="w-full mt-14 pb-20 flex flex-col gap-y-8 justify-center items-center">
            ...
            <div id="form" class="md:w-[60%]">
              <form action="" class="w-full">
                <div class="mt-2">
                  <label for="Username" class="font-semibold text-smlg:text-medium  mb-2"
                    >Email</label
                  >
                  <input
                    type="text"
                  ...
                  <span
                    id="usernameMessage"
                    class="hidden text-pink-500 text-sm"
                  ></span>
                </div>
                <div class="mt-6">
                  <label for="Username" class="font-semibold text-sm lg:text-medium mb-2"
                    >Password</label
                  >
                  <input
                    type="password"
