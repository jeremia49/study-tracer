    ...
    <main>
        <div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
            ...
            <div class="col-span-full">
                ...
                <div class="relative overflow-x-auto md:overflow-hidden shadow-md sm:rounded-lg bg-white px-4 dark:bg-gray-900 dark:shadow-slate-800 ">
                    <button type="button" data-tooltip-placement="right" data-tooltip-target="create-btn" data-modal-target="newSurveyModal" data-modal-toggle="newSurveyModal"
