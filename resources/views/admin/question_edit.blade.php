                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 space-y-6">
                            <form action="{{ route('admin.editQuestion', ['id' => $question->id]) }}" method="POST"
                                ...
                                <div class="p-6 space-y-2">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input type="text" id="question"
                                            ...
                                            value="{{ old('question', $question->question) }}" placeholder="Your question"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <select name="type" id="type"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-borderForm focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-borderForm dark:focus:border-blue-500">
                                            <option value="" class="capitalize text-sm" @selected(old('type', $question->type) == '')>
                                                Pilih Tipe Pertanyaan</option>
                                            <option value="text" class="capitalize text-sm" @selected(old('type', $question->type) == 'text')>
                                                Text &#40; Isian &#41;</option>
                                            <option value="radio" class="capitalize text-sm" @selected(old('type', $question->type) == 'radio')>
                                                Radio &#40; Pilihan memilih 1 opsi
                                                &#41;</option>
                                            <option value="radioOthers" class="capitalize text-sm"
                                                @selected(old('type', $question->type) == 'radioOthers')>Radio With Others &#40; Pilihan
                                                1 opsi w/ others &#41;</option>
                                            <option value="checkbox" class="capitalize text-sm"
                                                @selected(old('type', $question->type) == 'checkbox')>Checkbox &#40; Pilihan multi opsi
                                                &#41;</option>
                                            <option value="rate" class="capitalize text-sm" @selected(old('type', $question->type) == 'rate')>
                                    ...
                                    <div class="flex flex-wrap">
                                        <label
                                            class="w-full mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Apakah
                                            wajib diisi ?</label>
                                        <div class="flex flex-wrap items-center mr-4">
                                            <input id="red-radio" type="radio" value="1" name="is_mandatory"
                                                ...
                                                @checked(old('is_mandatory', $question->is_mandatory) == '1')>
                                            <label for="red-radio"
                                        ...
                                        <div class="flex items-center mr-4">
                                            <input id="not-required" type="radio" value="0" name="is_mandatory"
                                                ...
                                                @checked(old('is_mandatory', $question->is_mandatory) == '0')>
                                ...
                                <div
                                    ...
                                    <button type="submit" class="btn-submit-edit">Kirim</button>
                                </div>
                            </form>
                        </div>
                    </div>
