...
<head>
    ...
    <meta name="description" content="Halaman Responden Study Tracer" />
...
<body class="bg-gray-50 dark:bg-gray-800">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <button id="theme-toggle" data-tooltip-target="tooltip-toggle" type="button"
                        ...
                        <svg id="theme-toggle-dark-icon" class="hidden w-5 h-5 animate-[spin_450ms_ease-in-out]"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
                        </svg>
                        <svg id="theme-toggle-light-icon"
                            class="hidden w-5 h-5 animate-[spin_450ms_ease-in-out] text-white" fill="currentColor"
                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path
    ...
    <div id="main-content"
        class=" grid grid-cols-1 content-between relative w-full h-[90vh] overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
