    ...
    <main>
        <div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
            ...
            <div class="col-span-full bg-white dark:bg-gray-800 rounded-lg">
                ...
                <div
                    class="relative overflow-x-auto md:overflow-hidden shadow-md sm:rounded-lg bg-white px-4 py-2 dark:bg-gray-900 dark:shadow-slate-800">
                    <br>
                            ...
                            @empty
                                <tr class="border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                    <th scope="row"
                                        ...
                                        colspan="5">
                                        Untuk saat ini, tidak ada survey yang tersedia untuk anda
                                    </th>
                                </tr>
                            @endforelse
